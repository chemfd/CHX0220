...
| | * | 152 | 204 | 276 | 304 | 334 |
|[12]crown-4 | | | | | | |
|[15]crown-5 | 170-220 | | 3.48| 3.77 | |2.18 |
|[18]crown-6 | 260-320| |4.32 |6.10 | |4.62 |
|[21]crown-7 | 340-430 | |1.93 |4.41 | |5.02 |
...
```{r echo=FALSE, out.width='20%', fig.show='hold', fig.align='center', fig.cap='The cage structure [2.2.2]cryptand.'}
...
They were first reported by Jean-Marie Lehn.
...
| [2.1.1]cryptand | - | 3.9 / 7.9 | 5.4 / 10.4 |
...
```{r echo=FALSE, out.width='50%', fig.show='hold', fig.align='center', fig.cap='Podand (left), [18]crown-6 (center) and [2.2.2]cryptand (right), the binding constant to potassium increases as the rigidity in the ligand or macrocycle increases.'}
...
There are lots of other metal ion binders, often designed to be specific for paricular ions
